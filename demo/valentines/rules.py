"""Deterministic simulation rules for the valentines demo scenario."""
...
class ValentinesTownRules(SimulationRules):
    """Simple town-time physics for the Valentine's social diffusion scenario."""
...
TownSimulationRules = ValentinesTownRules
